...
content: "Welcome to Xerebo Technologies L.L.C - FZ. We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you about how we look after your personal data when you visit our website and tell you about your privacy rights and how the law protects you in the United Arab Emirates (UAE)."
},
{
...
{/* ✅ UPDATED: Contact box with full legal name + address */}
...
<p className="font-bold text-dark mb-1">Xerebo Technologies L.L.C - FZ</p>
<p className="text-dark/70 mb-1">Email: hello@xerebo.com</p>
<p className="text-dark/70">Address: Office 905, Capital Golden Tower,<br />Business Bay, Dubai, UAE</p>
</div>
</div>
</div>
</div>

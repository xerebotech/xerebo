...
import ContactFormFieldsLight from '@/components/ContactFormFieldsLight';

export default function ContactFormLight() {
    return (
        <section id="contact" className="px-6 pt-12 md:pt-20 pb-0 text-dark-deepest relative overflow-hidden bg-transparent">
            {/* Background Accents */}
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
                    ...
                    >
                        ...
                        <h2 className="text-4xl md:text-5xl lg:text-7xl font-black text-dark-deepest mb-6 font-heading leading-[0.9]">
                            Let's Build <br />
                            <span className="bg-gradient-to-r from-orange to-[#8A4B22] bg-clip-text text-transparent">Your Engine.</span>
                        </h2>

                        <p className="text-xl md:text-2xl text-dark-deepest/60 font-medium leading-relaxed max-w-xl mb-12">
                        ...
                        <div className="mb-6 text-dark-deepest/50 font-medium uppercase tracking-widest text-sm font-heading">What happens on the call:</div>
                        <div className="space-y-6 mb-12">
                            {[
                                ...
                                >
                                    ...
                                    <span className="text-dark-deepest/80 text-lg font-medium pt-1 leading-snug">{item.text}</span>
                                </motion.div>
                            ))}
                        </div>

                        {/* Contact Details Grid */}
                        <div className="grid grid-cols-2 gap-8 pt-8 border-t border-dark-deepest/10">
                            <div>
                                <h4 className="text-dark-deepest/50 text-xs uppercase tracking-widest mb-2 font-bold font-heading">Email</h4>
                                <a href="mailto:Hello@xerebo.com" className="text-dark-deepest hover:text-orange transition-colors font-medium">Hello@xerebo.com</a>
                            </div>
                            <div>
                    ...
                    >
                        <div className="w-full bg-white rounded-[3rem] p-8 md:p-12 border border-dark-deepest/10 shadow-2xl relative">
                            <ContactFormFieldsLight />
                        </div>
                    </motion.div>
                </div>
